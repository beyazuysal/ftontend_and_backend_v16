...
import 'package:yeni_kayan_ekran/isaretci_2/ui2/home2/call_page2.dart';
...
class HomePageVCState extends State<HomePage2> {
...
backgroundColor: Colors.grey.shade200,
          leading: IconButton(
            ...
            onPressed: () {
              ...
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) => LoginPage2(), // Yönlendirilecek sayfa
                ),
              );
            },
          ),
  ...
  void onTap() {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => CallPage2()));
  }
}
