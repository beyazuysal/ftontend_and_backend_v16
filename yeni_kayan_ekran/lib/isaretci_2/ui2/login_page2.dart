...
import 'package:yeni_kayan_ekran/isaretci_2/ui2/home2/home_page2.dart';
import 'package:yeni_kayan_ekran/isaretci_2/ui2/home2/home_page22.dart';
...
class LoginPage2 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => LoginPage2State();
}
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const HomePage22()),
                      );
                    },
                    child: Container(
                      padding: const EdgeInsets.all(20),
    ...
    CallModel.getUniqueUserId().then((userId) {
      ...
      Future.delayed(Duration(seconds: 2), () {
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  HomePage2(userId: userIdTextController.text)),
        );
      });
    });
  }
